...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">ROUTINE MANAGEMENT SYSTEM, BCA DEPARTMENT, CRTI</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/lab4.jpeg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> BCA IST SEMESTER </option>
            <option value="4"> BCA 2ND SEMESTER </option>
            <option value="5"> BCA 3RD SEMESTER </option>
            <option value="6"> BCA 4TH SEMESTER </option>
            <option value="7"> BCA 5TH SEMESTER </option>
            <option value="8"> BCA 6TH SEMESTER </option>
        </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/indranil.jpeg" class="img-rounded"/>
                    <h3 align="center">Prof. INDRANIL DEBGUPTA</h3>
                    <hr/>
                    <h4 align="center">CRTI<br/>PRINCIPAL</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/sugata.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF. SUGATA GHOSH</h3>
                    <hr/>
                    <h4 align="center">CRTI<br/> HOD BCA DEPT.</h4>
                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/sarjita.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF. SARJITA SOO</h3>
                    <hr/>
                    <h4 align="center">CRTI<br/>Assistant Professor</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Said Anywhere</h4>
                <h4><strong>Call:</strong> 0342 256 8909 Ext 2568896 </h4>
                <h4><strong>Email: </strong>info@bcrti.co.in</h4>
                <h4><strong>Develop by <br> || PRAMIT CHOUDHURY || <br> || RITWIK MUKHERJEE ||</strong></h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <hr/>
            <div>
                <a href="https://www.facebook.com/crti.burdwan"> <img src="assets/img/Social/facebook.png" alt=""/></a>
                <a href="https://www.bcrti.co.in/"> <img src="assets/img/Social/website.png" alt=""/></a>
